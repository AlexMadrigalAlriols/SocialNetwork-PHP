            ...
            <div class="card-body tab-content">
              <div class="tab-pane active" id="profile">
                ...
                <form id="frm" method="POST">
                  ...
                  <button type="submit" class="btn btn-primary" name="commandUpdateUser" value="1" style="float:right;">Update Account</button>
                  <button type="button" id="delteUserButton" class="btn btn-danger">Delete Account</button>
                </form>
              </div>

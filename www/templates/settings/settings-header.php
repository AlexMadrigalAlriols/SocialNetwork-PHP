          ...
          <div class="card">
            <div class="card-body">
              <nav class="nav flex-column nav-pills nav-gap-y-1">
                <a href="/settings" id="settingsProfile" class="nav-item nav-link has-icon nav-link-faded">
                ...
                <a href="/settings/notifications" id="settingsNotifications" class="nav-item nav-link has-icon nav-link-faded">
                ...
                <a href="/settings/account" id="settingsAccount" class="nav-item nav-link has-icon nav-link-faded">

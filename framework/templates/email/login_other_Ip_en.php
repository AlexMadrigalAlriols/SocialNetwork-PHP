                            ...
                            <table width="650px"
                                ...
                                <tr>
                                    <td bordercolor="#4723D9"
                                        ...
                                        <p style="font-size:24pt;"><strong style="color: 4723D9">New Login</strong></p>
                                        <p>Hi, @<?=$username;?></p>
                                        <p>You recently log in from a new device, browser, or location. If you did not make this request, please change your password.</p>

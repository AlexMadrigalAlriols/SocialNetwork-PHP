                            ...
                            <table width="650px"
                                ...
                                <tr>
                                    <td bordercolor="#4723D9"
                                        ...
                                        <p style="font-size:24pt;">Welcome <strong
                                                style="color: 4723D9">@<?=$username?></strong>,</p>
                                        <p>Welcome to MTGCollectioner, your social network, collection & deck manager AND tournament finder for Magic The Gathering.</p>
                                        <p><strong>Verify your account to prevent elimination and grant access to all freature:
                                        </p>
                                        <a href="https://mtgcollectioner.com/verify/<?=$verify_code;?>" rel="nofollow"

                            ...
                            <table width="650px"
                                ...
                                <tr>
                                    <td bordercolor="#4723D9"
                                        ...
                                        <p style="font-size:24pt;"><strong style="color: 4723D9">Account Changes</strong></p>
                                        <p>Hi, @<?=$username;?></p>
                                        <p>You have successfully changed your MTGCollectioner account settings.</p>
                                        <p><strong>If you did not make this request, please  <a href="https://mtgcollectioner.com/forgot-password/<?=$verify_code . "#" . $id_user . "#" . sha1($username)?>">reset passwords</a> of your account.</p>
                                    </td>
                                </tr>
                                <tr>

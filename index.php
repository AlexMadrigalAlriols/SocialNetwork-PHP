            ...
            <div class="mt-3 bg-dark text-white rounded container">
                ...
                <form action="" class="justify-content-md-center" method="post" enctype="multipart/form-data">
                    ...
                    <div class="buttons mt-2">
                        ...
                        <button class="btn btn-dark-primary active m-2 d-inline-block" name="command_publish" style="float:right;" type="submit" value="1">Publish</button>
                    </div>
                </form>
            </div>
                            ...
                            <div>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item mt-1" href="#"><i class="fa-regular fa-flag"></i> Report Publication</a></li>
                                    </ul>
                                </div>
                    ...
                    <div class="col-md-5">
                        ...
                        <hr>
                            <div class="input-group mb-3">
                                <textarea class="form-control" placeholder="Comment Something" aria-label="Comment Something" aria-describedby="button-addon2" style="resize: none;" rows="1" id="comment_msg"></textarea>
